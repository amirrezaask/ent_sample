...
func (cq *CourseQuery) sqlAll(ctx context.Context) ([]*Course, error) {
	...
	if query := cq.withStudents; query != nil {
		...
		ids := make(map[int]*Course, len(nodes))
...
func (cgb *CourseGroupBy) Strings(ctx context.Context) ([]string, error) {
	if len(cgb.fields) > 1 {
		return nil, errors.New("models: CourseGroupBy.Strings is not achievable when grouping more than 1 field")
	}
	var v []string
	if err := cgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (cgb *CourseGroupBy) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{course.Label}
	default:
		err = fmt.Errorf("models: CourseGroupBy.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (cgb *CourseGroupBy) Ints(ctx context.Context) ([]int, error) {
	if len(cgb.fields) > 1 {
		return nil, errors.New("models: CourseGroupBy.Ints is not achievable when grouping more than 1 field")
	}
	var v []int
	if err := cgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (cgb *CourseGroupBy) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{course.Label}
	default:
		err = fmt.Errorf("models: CourseGroupBy.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (cgb *CourseGroupBy) Float64s(ctx context.Context) ([]float64, error) {
	if len(cgb.fields) > 1 {
		return nil, errors.New("models: CourseGroupBy.Float64s is not achievable when grouping more than 1 field")
	}
	var v []float64
	if err := cgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (cgb *CourseGroupBy) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{course.Label}
	default:
		err = fmt.Errorf("models: CourseGroupBy.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (cgb *CourseGroupBy) Bools(ctx context.Context) ([]bool, error) {
	if len(cgb.fields) > 1 {
		return nil, errors.New("models: CourseGroupBy.Bools is not achievable when grouping more than 1 field")
	}
	var v []bool
	if err := cgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (cgb *CourseGroupBy) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{course.Label}
	default:
		err = fmt.Errorf("models: CourseGroupBy.Bools returned %d results when one was expected", len(v))
	}
	return
}
...
func (cs *CourseSelect) Strings(ctx context.Context) ([]string, error) {
	if len(cs.fields) > 1 {
		return nil, errors.New("models: CourseSelect.Strings is not achievable when selecting more than 1 field")
	}
	var v []string
	if err := cs.Scan(ctx, &v); err != nil {
		return nil, err
...
func (cs *CourseSelect) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{course.Label}
	default:
		err = fmt.Errorf("models: CourseSelect.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (cs *CourseSelect) Ints(ctx context.Context) ([]int, error) {
	if len(cs.fields) > 1 {
		return nil, errors.New("models: CourseSelect.Ints is not achievable when selecting more than 1 field")
	}
	var v []int
	if err := cs.Scan(ctx, &v); err != nil {
		return nil, err
...
func (cs *CourseSelect) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{course.Label}
	default:
		err = fmt.Errorf("models: CourseSelect.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (cs *CourseSelect) Float64s(ctx context.Context) ([]float64, error) {
	if len(cs.fields) > 1 {
		return nil, errors.New("models: CourseSelect.Float64s is not achievable when selecting more than 1 field")
	}
	var v []float64
	if err := cs.Scan(ctx, &v); err != nil {
		return nil, err
...
func (cs *CourseSelect) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{course.Label}
	default:
		err = fmt.Errorf("models: CourseSelect.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (cs *CourseSelect) Bools(ctx context.Context) ([]bool, error) {
	if len(cs.fields) > 1 {
		return nil, errors.New("models: CourseSelect.Bools is not achievable when selecting more than 1 field")
	}
	var v []bool
	if err := cs.Scan(ctx, &v); err != nil {
		return nil, err
...
func (cs *CourseSelect) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{course.Label}
	default:
		err = fmt.Errorf("models: CourseSelect.Bools returned %d results when one was expected", len(v))
	}
	return
}
