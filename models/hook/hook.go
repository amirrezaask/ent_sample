...
type CourseFunc func(context.Context, *models.CourseMutation) (models.Value, error)

// Mutate calls f(ctx, m).
func (f CourseFunc) Mutate(ctx context.Context, m models.Mutation) (models.Value, error) {
	mv, ok := m.(*models.CourseMutation)
	if !ok {
		return nil, fmt.Errorf("unexpected mutation type %T. expect *models.CourseMutation", m)
	}
	return f(ctx, mv)
}
...
type StudentFunc func(context.Context, *models.StudentMutation) (models.Value, error)

// Mutate calls f(ctx, m).
func (f StudentFunc) Mutate(ctx context.Context, m models.Mutation) (models.Value, error) {
	mv, ok := m.(*models.StudentMutation)
	if !ok {
		return nil, fmt.Errorf("unexpected mutation type %T. expect *models.StudentMutation", m)
	}
	return f(ctx, mv)
}
