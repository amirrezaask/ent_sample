...
func (sq *StudentQuery) sqlAll(ctx context.Context) ([]*Student, error) {
	...
	if query := sq.withCourses; query != nil {
		...
		ids := make(map[int]*Student, len(nodes))
...
func (sgb *StudentGroupBy) Strings(ctx context.Context) ([]string, error) {
	if len(sgb.fields) > 1 {
		return nil, errors.New("models: StudentGroupBy.Strings is not achievable when grouping more than 1 field")
	}
	var v []string
	if err := sgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (sgb *StudentGroupBy) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{student.Label}
	default:
		err = fmt.Errorf("models: StudentGroupBy.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (sgb *StudentGroupBy) Ints(ctx context.Context) ([]int, error) {
	if len(sgb.fields) > 1 {
		return nil, errors.New("models: StudentGroupBy.Ints is not achievable when grouping more than 1 field")
	}
	var v []int
	if err := sgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (sgb *StudentGroupBy) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{student.Label}
	default:
		err = fmt.Errorf("models: StudentGroupBy.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (sgb *StudentGroupBy) Float64s(ctx context.Context) ([]float64, error) {
	if len(sgb.fields) > 1 {
		return nil, errors.New("models: StudentGroupBy.Float64s is not achievable when grouping more than 1 field")
	}
	var v []float64
	if err := sgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (sgb *StudentGroupBy) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{student.Label}
	default:
		err = fmt.Errorf("models: StudentGroupBy.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (sgb *StudentGroupBy) Bools(ctx context.Context) ([]bool, error) {
	if len(sgb.fields) > 1 {
		return nil, errors.New("models: StudentGroupBy.Bools is not achievable when grouping more than 1 field")
	}
	var v []bool
	if err := sgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (sgb *StudentGroupBy) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{student.Label}
	default:
		err = fmt.Errorf("models: StudentGroupBy.Bools returned %d results when one was expected", len(v))
	}
	return
}
...
func (ss *StudentSelect) Strings(ctx context.Context) ([]string, error) {
	if len(ss.fields) > 1 {
		return nil, errors.New("models: StudentSelect.Strings is not achievable when selecting more than 1 field")
	}
	var v []string
	if err := ss.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ss *StudentSelect) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{student.Label}
	default:
		err = fmt.Errorf("models: StudentSelect.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (ss *StudentSelect) Ints(ctx context.Context) ([]int, error) {
	if len(ss.fields) > 1 {
		return nil, errors.New("models: StudentSelect.Ints is not achievable when selecting more than 1 field")
	}
	var v []int
	if err := ss.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ss *StudentSelect) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{student.Label}
	default:
		err = fmt.Errorf("models: StudentSelect.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (ss *StudentSelect) Float64s(ctx context.Context) ([]float64, error) {
	if len(ss.fields) > 1 {
		return nil, errors.New("models: StudentSelect.Float64s is not achievable when selecting more than 1 field")
	}
	var v []float64
	if err := ss.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ss *StudentSelect) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{student.Label}
	default:
		err = fmt.Errorf("models: StudentSelect.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (ss *StudentSelect) Bools(ctx context.Context) ([]bool, error) {
	if len(ss.fields) > 1 {
		return nil, errors.New("models: StudentSelect.Bools is not achievable when selecting more than 1 field")
	}
	var v []bool
	if err := ss.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ss *StudentSelect) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{student.Label}
	default:
		err = fmt.Errorf("models: StudentSelect.Bools returned %d results when one was expected", len(v))
	}
	return
}
