...
func (su *StudentUpdate) SetBirthYear(i int) *StudentUpdate {
	su.mutation.ResetBirthYear()
	su.mutation.SetBirthYear(i)
	return su
}

// AddBirthYear adds i to the "birth_year" field.
func (su *StudentUpdate) AddBirthYear(i int) *StudentUpdate {
	su.mutation.AddBirthYear(i)
	return su
}

// AddCourseIDs adds the "courses" edge to the Course entity by IDs.
func (su *StudentUpdate) AddCourseIDs(ids ...int) *StudentUpdate {
...
func (su *StudentUpdate) RemoveCourseIDs(ids ...int) *StudentUpdate {
...
func (su *StudentUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := su.mutation.BirthYear(); ok {
		_spec.Fields.Set = append(_spec.Fields.Set, &sqlgraph.FieldSpec{
			Type:   field.TypeInt,
			Value:  value,
	...
	if value, ok := su.mutation.AddedBirthYear(); ok {
...
// SetBirthYear sets the "birth_year" field.
func (suo *StudentUpdateOne) SetBirthYear(i int) *StudentUpdateOne {
	suo.mutation.ResetBirthYear()
	suo.mutation.SetBirthYear(i)
	return suo
}

// AddBirthYear adds i to the "birth_year" field.
func (suo *StudentUpdateOne) AddBirthYear(i int) *StudentUpdateOne {
	suo.mutation.AddBirthYear(i)
	return suo
}

// AddCourseIDs adds the "courses" edge to the Course entity by IDs.
func (suo *StudentUpdateOne) AddCourseIDs(ids ...int) *StudentUpdateOne {
...
// RemoveCourseIDs removes the "courses" edge to Course entities by IDs.
func (suo *StudentUpdateOne) RemoveCourseIDs(ids ...int) *StudentUpdateOne {
...
func (suo *StudentUpdateOne) sqlSave(ctx context.Context) (_node *Student, err error) {
	...
	if value, ok := suo.mutation.BirthYear(); ok {
		_spec.Fields.Set = append(_spec.Fields.Set, &sqlgraph.FieldSpec{
			Type:   field.TypeInt,
			Value:  value,
			Column: student.FieldBirthYear,
	...
	if value, ok := suo.mutation.AddedBirthYear(); ok {
		_spec.Fields.Add = append(_spec.Fields.Add, &sqlgraph.FieldSpec{
			Type:   field.TypeInt,
			Value:  value,
			Column: student.FieldBirthYear,
